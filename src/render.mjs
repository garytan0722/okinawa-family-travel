import { getPartyForDate, getStayForDate, mapUrl } from './trip-domain.mjs?v=8';
  ...
  return `
    <li class="event-card${isDone ? ' is-complete' : ''}" data-event-id="${escapeHtml(event.id)}">
      ...
      <label class="event-check">
        ...
        <span class="check-paw" aria-hidden="true"><img class="dog-paw-stamp" src="./icons/dog-paw-stamp.svg?v=8" alt=""></span>
