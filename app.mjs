import { getVariantDay, mapUrl, nextFixedEvent } from './src/trip-domain.mjs?v=8';
import { centeredScrollLeft, renderDay, renderEmergencyView, renderFlightSummary, renderSources, renderVariantTabs, escapeHtml } from './src/render.mjs?v=8';
import { createEmptyState, exportBackup, importBackup, loadState, saveState } from './src/storage.mjs?v=8';
import { installPwaUpdate } from './src/pwa-update.mjs?v=8';
...
async function boot() {
  try {
    const response = await fetch('./content/trip.json?v=8');
