import { getVariantDay, mapUrl, nextFixedEvent } from './src/trip-domain.mjs?v=16';
import { centeredScrollLeft, renderDay, renderEmergencyView, renderFlightSummary, renderRainyDayView, renderSources, renderVariantTabs, escapeHtml } from './src/render.mjs?v=16';
import { createEmptyState, exportBackup, importBackup, loadState, saveState } from './src/storage.mjs?v=16';
import { installPwaUpdate } from './src/pwa-update.mjs?v=16';
...
async function boot() {
  try {
    const response = await fetch('./content/trip.json?v=16');
