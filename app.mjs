import { getVariantDay, mapUrl, nextFixedEvent } from './src/trip-domain.mjs?v=28';
import { centeredScrollLeft, renderChecklistView, renderDay, renderEmergencyView, renderFlightSummary, renderPrivateBookingVault, renderRainyDayView, renderSources, renderStayAction, renderTicketPassGuide, renderVariantTabs, escapeHtml } from './src/render.mjs?v=28';
import { parseOtsReservations } from './src/private-bookings.mjs?v=28';
import { clearRainBackup, selectRainBackup, toggleRainMode } from './src/rain-state.mjs?v=28';
import { createEmptyState, exportBackup, importBackup, loadState, saveState } from './src/storage.mjs?v=28';
import { installPwaUpdate } from './src/pwa-update.mjs?v=28';
...
async function boot() {
  try {
    const response = await fetch('./content/trip.json?v=28');
