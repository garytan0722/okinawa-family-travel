import { getVariantDay, mapUrl, nextFixedEvent } from './src/trip-domain.mjs?v=17';
import { centeredScrollLeft, renderDay, renderEmergencyView, renderFlightSummary, renderRainyDayView, renderSources, renderVariantTabs, escapeHtml } from './src/render.mjs?v=17';
import { createEmptyState, exportBackup, importBackup, loadState, saveState } from './src/storage.mjs?v=17';
import { installPwaUpdate } from './src/pwa-update.mjs?v=17';
...
async function boot() {
  try {
    const response = await fetch('./content/trip.json?v=17');
